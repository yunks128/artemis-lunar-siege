...
function applyLang(){
  ...
  $("foot").innerHTML = LANG==="en"
    ? "ARTEMIS: LUNAR SIEGE · original work · MIT licensed · <a href='https://github.com/yunks128/artemis-lunar-siege' target='_blank' rel='noopener'>source</a>"
    : "ARTEMIS: LUNAR SIEGE · 오리지널 작품 · MIT 라이선스 · <a href='https://github.com/yunks128/artemis-lunar-siege' target='_blank' rel='noopener'>소스</a>";
